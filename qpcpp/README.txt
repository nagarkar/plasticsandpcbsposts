...
- bug#152 Typo (ports\arm7-9\qk\gnu\qk_port.s:42) prevents compilation
...
Also, this release improves the implementation of scheduler locking
in publish-subscribe event delivery.

Finally, this release fixes the following bugs:
- bug#132 (Posix port mutex double-lock triggers undefined behaviour)
