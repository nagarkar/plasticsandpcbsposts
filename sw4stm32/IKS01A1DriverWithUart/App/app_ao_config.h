...
#define SIG_LIST(m)  \
	...
	\
	m(Signal, IKS01A1_ACC_STOP_REQ_SIG)    \
	m(Signal, IKS01A1_ACC_STOP_CFM_SIG)    \
	m(Signal, IKS01A1_ACC_START_REQ_SIG)    \
	m(Signal, IKS01A1_ACC_START_CFM_SIG)    \
	m(Signal, IKS01A1_ACC_INTERVAL_TIMER_SIG)    \
	m(Signal, IKS01A1_ACC_COMPONENT_FAILED_SIG)    \
	\
	m(Signal, ABUMP_DET_START_REQ_SIG)    \
	m(Signal, ABUMP_DET_START_CFM_SIG)    \
	m(Signal, ABUMP_DET_STOP_REQ_SIG)    \
	m(Signal, ABUMP_DET_STOP_CFM_SIG)    \
	m(Signal, ABUMP_DET_FAILED_SIG)    \
	m(Signal, ABUMP_DET_TIMEOUT_SIG)    \
	m(Signal, ABUMP_DETECTED_SIG)	\
	\
	m(Signal, WHEEL_DRIVES_DD_TIMEOUT_SIG)	\
	m(Signal, WHEEL_DRIVES_DD_HEADING_CFM_SIG)	\
	m(Signal, WHEEL_DRIVES_DD_HEADING_SIG)	\
	m(Signal, WHEEL_DRIVES_DD_START_REQ_SIG)	\
	m(Signal, WHEEL_DRIVES_DD_START_CFM_SIG)	\
	m(Signal, WHEEL_DRIVES_DD_STOP_REQ_SIG)	\
	m(Signal, WHEEL_DRIVES_DD_STOP_CFM_SIG)	\
	m(Signal, WHEEL_DRIVES_DD_FAILED_SIG)	\
	\
	m(Signal, WHEEL_DRIVES_WHEEL_TIMEOUT_SIG)	\
	m(Signal, WHEEL_DRIVES_WHEEL_MOVE_REQ_SIG)	\
	m(Signal, WHEEL_DRIVES_WHEEL_MOVE_CFM_SIG)	\
	m(Signal, WHEEL_DRIVES_WHEEL_START_REQ_SIG)	\
	m(Signal, WHEEL_DRIVES_WHEEL_START_CFM_SIG)	\
	m(Signal, WHEEL_DRIVES_WHEEL_STOP_REQ_SIG)	\
	m(Signal, WHEEL_DRIVES_WHEEL_STOP_CFM_SIG)	\
	\
	m(Signal, NAV_UNOBSTRUCTED_GOAL_SIG)	\
	m(Signal, NAV_OBST_DANGER_ZONE_IND_SIG)	\
	m(Signal, NAV_OBST_CLOSE_IND_SIG)	\
	\
	m(Signal, WHEEL_DRIVES_BUMPER_TIMEOUT_SIG)	\
	m(Signal, WHEEL_DRIVES_BUMPER_BUMPED_SIG)	\
	m(Signal, WHEEL_DRIVES_BUMPER_UNBUMPED_SIG)	\
	\
	m(Signal, SYSTEM_PIN_SET_INTERRUPT_SIG)	\
	m(Signal, SYSTEM_PIN_RESET_INTERRUPT_SIG)	\
	\
